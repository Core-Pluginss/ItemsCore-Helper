...
function itemSchema(idx) {
  return {
    ...
    fields: {
      ...
      lore: "string[] - lore lines. Support & color codes, &#RRGGBB hex, MiniMessage tags, %placeholders%, {var_KEY} item variables, {stats} (expands to the stat block), and {requirement:&ctext} (shown only while the holder fails the item's requirements).",
